...
- (void)bluetoothDeviceConnectSuccess:(NSNotification*)notification {
    NSLog(@"bluetoothDeviceConnectSuccess");
    
    for (id<MDBluetoothObserverProtocol> observer in self.observers) {
        [observer receivedBluetoothNotification:MDBluetoothDeviceConnectSuccessNotification];
    }

    //[[BluetoothManager sharedInstance]cancelPairing];
}

- (void)bluetoothConnectabilityChanged:(NSNotification*)notification {
    NSLog(@"bluetoothConnectabilityChanged");
}

- (void)bluetoothDeviceUpdated:(NSNotification*)notification {
    NSLog(@"bluetoothDeviceUpdated");
}

- (void)bluetoothDiscoveryStateChanged:(NSNotification*)notification {
    //NSLog(@"bluetoothDiscoveryStateChanged");
}

- (void)bluetoothConnectionStatusChanged:(NSNotification*)notification {
    NSLog(@"bluetoothConnectionStatusChanged");
}

- (void)bluetoothDeviceDisconnectSuccess:(NSNotification*)notification {
    NSLog(@"bluetoothDeviceDisconnectSuccess");
}
